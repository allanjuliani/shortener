# Generated by Django 2.2 on 2019-04-11 15:55
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('shortened', models.CharField(blank=True, max_length=5, unique=True, verbose_name='Shortened')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('latitude', models.CharField(blank=True, max_length=8, null=True, verbose_name='Latitude')),
                ('longitude', models.CharField(blank=True, max_length=8, null=True, verbose_name='Longitude')),
                ...
                ('shortener', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='shortener.Shortener', verbose_name='Shortener')),
            ],
            options={
                'verbose_name': 'Log',
